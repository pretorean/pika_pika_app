...
import 'package:pika_pika_app/ui/base/error/network_error_handler.dart';
import 'package:pika_pika_app/ui/base/material_message_controller.dart';
import 'package:pika_pika_app/ui/res/strings/common_strings.dart';
...
class StandardErrorHandler extends NetworkErrorHandler {
  ...
  void _show(String msg) {
    return _messageController.show(
      msg: msg,
      msgType:
          MsgType.commonError, //todo выделить base модуль для всех в стандарте
    );
  }
}
