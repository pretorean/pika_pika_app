...
import 'package:pika_pika_app/ui/base/owners/dialog_owner.dart';
import 'package:pika_pika_app/ui/common/dialog/alert_dialog.dart';
import 'package:pika_pika_app/util/enum.dart';
...
class DatePickerDialogController {
  ...
  Stream<DateTime> show({
    ...
    if (Theme.of(_scaffoldContext).platform == TargetPlatform.android) {
      ...
      var controller = StreamController<DateTime>();
